...
- **/ship has no CHANGELOG release rotation** — no step rotates `[Unreleased]` into a dated version heading; releases currently need a manual `update-changelog.sh --release` run. See `docs/learnings/skill-ship-no-changelog-release-rotation.md`.
